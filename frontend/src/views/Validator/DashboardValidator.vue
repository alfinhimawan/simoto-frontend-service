            ...
            <div class="card">
              <div class="p-3 pb-0 card-header">
                <div class="d-flex flex-column align-items-center">
                  <h6 class="mb-2">Welcome to Simoto Dany As Validator</h6>
                  <!-- <img
                    src="https://source.unsplash.com/500x500/?admin"
                    alt="Admin Image"
                    class="admin-image"
                  /> -->
                  <img src="../../../src/assets/img/image_login.jpg" alt="Validator Image" class="validator-image" />
                </div>
              </div>
...
export default {
  name: "dashboard-validator-default",
  data() {
    return {
      stats: {
        money: {
