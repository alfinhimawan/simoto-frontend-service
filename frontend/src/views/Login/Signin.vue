      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="text-white mb-2 mt-5">Welcome To SIMOTO!</h1>
            <p class="text-lead text-white">
              The Motor and Operational Information System is a system
              development project aimed at facilitating the borrowing and
              management of motorcycles at the company PT LDP Yogyakarta.
            </p>
          </div>
        </div>
      </div>
